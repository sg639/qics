    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            ...
            var container = $("<div></div>", {
                ...
                "    <input type='text' autocomplete='off' style='width: 25px;' class='select2-input' readonly='readonly' "+opt+"  >" ,
                "  </li>" ,
                "</ul>" ,
        ...
        clearSearch: function () {
			...
			//alert( placeholder !== undefined  && this.getVal().length === 0  );
        ...
        addSelectedChoice: function (data) {
            ...
            choice.find(".select2-search-choice-close")
				.bind("mousedown", this.bind(function (e) {
					killEvent(e);
		            this.container.addClass("select2-dropdown-open").addClass("select2-container-active");
					this.newResize();
				}))
                ...
                $(e.target).closest(".select2-search-choice").fadeOut('fast').animate({width: "hide"}, 0, this.bind(function(){
        ...
        postprocessResults: function () {
            ...
            choices.each2(function (i, choice) {
				...
				if( first && !choice.hasClass("select2-disabled") ) {
					first = false;
					choice.find(".select2-result-label").addClass("select2-first");
				}
				else {
					choice.find(".select2-result-label").removeClass("select2-first");
				}
            });
		...
		newResize:function() {
			this.search.width(10);
			if( this.container.width()<100 && 100-this.container.width()>15) {
				this.search.width( 100-this.container.width() );
			}
			else {
				this.search.width( 15 );
			}
		}
    });
