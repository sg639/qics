            	...
            	<div class="row">
                   	<div class="col-xs-3">
                        ...
                        <button id="my-button3" type="button" class="btn btn-default pull-left">분할양식추가</button>
               			-->
               			<button id="orgBg" name="orgBg"  type="button" class="btn btn-success  pull-left">원본보기</button>
                		<button id="viewUser" name="viewUser" type="button" class="btn pull-left">보정데이터 보기</button>               			
            		</div>
            		<div class="col-xs-4">
               			<button id="my-button2" type="button" class="btn btn-danger pull-left m-r-xs" ><i class="fa fa-exclamation-triangle"></i><span id = "reportNm"></span></button>               			
            		</div>
            		<div class="col-xs-5">
               			...
               			-->
               			<button id="statusText" type="button" class="btn <%=STATUS_CSS %> pull-right m-r-xs"><%= STATUS_NM%></button>
               			<button id="printBtn" type="button" class="btn btn-primary pull-right m-r-xs" style="display: none;" onclick="javascript:ImagePrint();"><i class="fa fa-print"></i> 인쇄하기</button>
            		</div>
            	</div>     
			</div>         
        </div>
